student-00-43a5829480ce@linux-instance:~$ cat ./start_date_report.py
#!/usr/bin/env python3
...
def get_same_or_newer(start_date,data):
    ...
    for row in reader:
        #print(row)
        rec_list = list(row.split(","))
        #print(rec_list)
        row_date = datetime.datetime.strptime(rec_list[3], '%Y-%m-%d')
        ...
        # employees at the minimal date.
        if row_date == min_date:
            min_date_employees.append("{} {}".format(rec_list[0], rec_list[1]))
